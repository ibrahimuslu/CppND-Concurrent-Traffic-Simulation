...
void TrafficLight::waitForGreen()
{
    ...
    while(true){
      TrafficLightPhase message = tl.receive();
      std::cout << "TraLight turned to #" << message << " TrafficLight:: thread id = " << std::this_thread::get_id() << std::endl;
...
void TrafficLight::cycleThroughPhases()
{
    ...
    while(true){
      ...
      //std::cout << "Light turned to #" << timeSinceLastUpdate << " TrafficLight:: thread id = " << std::this_thread::get_id() << std::endl;
        if (timeSinceLastUpdate >= cycleDuration)
        {
            std::cout << "Light turned to #" << getCurrentPhase() << " TrafficLight:: thread id = " << std::this_thread::get_id() << std::endl;
